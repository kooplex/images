...
chown $IDD:$IDD /var/lib/rstudio-server/ -R
sudo -u $NB_USER env -u $IDD -u $IDD /usr/lib/rstudio-server/bin/rserver --auth-none=1 --auth-validate-users=0  --auth-stay-signed-in-days=30 --server-user=$NB_USER
