...
# Ref: https://github.com/nginxinc/docker-nginx/blob/f958fbacada447737319e979db45a1da49123142/mainline/ubuntu/Dockerfile

# Standard set up Nginx
export NGINX_VERSION=1.23.1-1~focal
#export NJS_VERSION=0.7.3
#export PKG_RELEASE=1~focal
